...
def main(page: ft.Page):
    ...
    Avances_tecnologicos = ft.Audio(src="avances tec.mp3", volume=1, balance=0)
    page.overlay.append(Avances_tecnologicos)
    ...
    #creacion de los botones de lenguajes de programacion
                            ...
                            ft.Column(
                                controls=[
                                    ...
                                    ElevatedButton(
                                        ...
                                        on_click=lambda _: [StopAll(), page.go('/avances')]
                                    ),
                                    ft.Image(
                                        src="museo de la tecnologia.png",
